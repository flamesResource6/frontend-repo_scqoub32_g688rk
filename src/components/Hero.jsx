      ...
      <div className="relative mx-auto max-w-6xl px-4 py-24 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative">
          <motion.div
            ...
            className="aspect-[4/3] rounded-xl bg-gradient-to-br from-emerald-200/60 to-emerald-100 border border-emerald-300/60 shadow-inner"
          />
          <p className="mt-3 text-sm text-slate-500">Community health visualization</p>
          {/* floating blobs */}
          <motion.span
            aria-hidden
            className="absolute -top-6 -left-6 h-24 w-24 rounded-full bg-emerald-300/40 blur-2xl"
            animate={{ y: [0, -10, 0], opacity: [0.6, 0.9, 0.6] }}
            transition={{ repeat: Infinity, duration: 6 }}
          />
          <motion.span
            aria-hidden
            className="absolute -bottom-6 -right-10 h-24 w-24 rounded-full bg-emerald-400/30 blur-2xl"
            animate={{ y: [0, 10, 0], opacity: [0.6, 0.9, 0.6] }}
